...
- Para aprendizado, foram utilizados [MVVM](https://github.com/Jonathan2332/so-bicos-flutter/tree/main-mvvm), Bloc (em breve) and Mobx (em breve) em branches separadas, sendo o resto do projeto o mesmo código
