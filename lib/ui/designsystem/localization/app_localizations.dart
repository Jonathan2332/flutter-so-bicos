...
abstract class AppLocalizations {
  ...
  /// No description provided for @this_field_cant_be_empty_or_blank.
  ///
  /// In en, this message translates to:
  /// **'This field can\'t be empty or blank'**
  String get this_field_cant_be_empty_or_blank;

  /// No description provided for @this_field_requires_a_valid_email.
  ///
  /// In en, this message translates to:
  /// **'This field requires a valid email'**
  String get this_field_requires_a_valid_email;

  /// No description provided for @password_mus_be_at_least_characters.
  ///
  /// In en, this message translates to:
